...
# Load dataset
dataset = load_dataset("json", data_files="wp_fr_phys.jsonl", split="train")
...
model = SentenceTransformer("pm-minilm-L12-v2_wp_all_en_all_es_chem_molcell_fr_ft")
...
# Save model
model.save("pm-minilm-L12-v2_wp_all_lang_ft")
print("Model saved")